...
Tu te lèves, désorienté. Tu essaies de parler à un passant, mais il te regarde, cligne de ses quatre yeux, marmonne quelque chose et s’éloigne. Tu ne comprends rien. Même les panneaux autour de toi sont dans une écriture totalement étrangère.

C’est alors qu’un petit drone volant, ressemblant à une méduse mécanique, s’approche. Il t’analyse, bzzzzt, puis laisse tomber un petit objet noir au sol : un traducteur universel auriculaire. Tu l’insères dans ton oreille droite. Soudain, les voix autour de toi deviennent compréhensibles. Tu entends :

— « ...le transport intersphérique a été suspendu suite à une défaillance énergétique... »

Tu comprends alors la gravité de ta situation : la machine qui t’a transporté ici est cassée, et pour rentrer chez toi, tu vas devoir retrouver ses pièces dans un monde inconnu, dangereux et qui ne t’attendait pas.

## [3]

Tu fais la connaissance de Nara, une mécanicienne Mirolienne (mi-humaine, mi-robotique), qui t’explique que les pièces dont tu as besoin sont réparties sur différentes planètes de la Confédération Zenthari. Mais attention : ces planètes ne sont pas toutes hospitalières. Certaines sont en guerre, d’autres hostiles à toute forme de vie étrangère.

## [3.1]


Tu acceptes de partir en quête des pièces avec son aide. Elle te prête un vaisseau rafistolé — le Cribleur — et un petit robot nommé Pix, ton guide maladroit mais loyal.

## [4]

Ta première escale est sur la planète Skarh’th, un monde désertique ravagé par des tempêtes d’acide. Là, tu dois infiltrer une base militaire abandonnée pour récupérer un noyau énergétique. Mais la base est infestée de vargs nocturnes, des créatures qui chassent au son.

Tu choisis :

A: Entrer en douce la nuit, malgré les vargs.

B: Tenter de négocier avec des contrebandiers locaux pour obtenir la pièce contre un service.

## [5.1]

Tu attends que le soleil de Skarh’th se couche derrière l’horizon de roche noire. Le vent hurle, portant des grains de sable acide qui picotent ta combinaison. Pix flotte nerveusement à côté de toi, ses capteurs s’agitant.

— « Mauvaise idée... très mauvaise idée... Les vargs sortent à cette heure-là. »

Tu allumes ta lampe à lumière noire, capable de révéler les empreintes thermiques. Lentement, tu t’infiltres dans la base en ruine.

Soudain, un grognement.

Un varg, haut de deux mètres, ses yeux luisants comme des braises, surgit derrière toi. Tu as quelques secondes pour réagir :

Choisis :
A: Utiliser le flash de ton traducteur pour désorienter la créature.
B: Tenter de rester immobile et silencieux, espérant qu’il ne te détecte pas.
...
— « Nous avons le noyau énergétique. Tu l’auras… si tu fais une livraison pour nous. Juste une petite caisse. Rien de dangereux. »

Pix t’affiche discrètement un avertissement : la caisse contient probablement des explosifs instables.

Choisis :
A: Accepter la mission de livraison sans poser de questions.
B: Tenter de voler la pièce au Zhirkal.
...
→ Tu obtiens la pièce, mais tu devras voyager discrètement à l’avenir.
...
→ Tu as la pièce, mais chaque port spatial deviendra une zone de danger.


## [6]

Avec le noyau énergétique en main, tu dois maintenant trouver l’oscillateur dimensionnel, une autre pièce essentielle… sur une planète aquatique dominée par une civilisation pacifiste... en apparence.
...
À ton arrivée à la cité flottante de Rehl-Tua, tu es accueilli par une émissaire Né’Kaari nommée Selyna, qui te dit :

— « L’oscillateur dont tu parles est un artefact sacré. Tu ne pourras y accéder que si tu passes l’Épreuve de l’Équilibre, un rite ancestral. »
...
Choisis :
A: Avancer lentement et prudemment, même si cela te fatigue.
B: Traverser rapidement avant que la structure ne s’effondre.
...
→ Tu obtiens la pièce sans conflit. Ta réputation auprès des Né’Kaari est excellente.
...
Choisis :
A: Tenter de pirater un drone pour accéder au sanctuaire.
B: Nager discrètement jusqu’au centre en évitant les capteurs.
...
→ Tu obtiens la pièce. Mais ton intrusion a été enregistrée. Tu es désormais recherché sur Velmor.
...
Dès ton arrivée, tu es pris pour cible par un groupe de pirates cybernétiques, des hybrides machine-organique, menés par le terrifiant Capitaine Varkoss. Ton vaisseau est tracté de force vers leur hangar spatial.
...
— « Avec cette carte… je peux réparer le système de saut. Reviens vite. »
...
→ Tu survis de justesse, mais la machine est irréparable. Tu es bloqué ici.
...
Nara, les bras croisés, t’observe sans rien dire. Pix vole en cercle, inquiet.
...
Elle te sourit, sans rien dire.

Pix s’approche.

— « Tu vas me manquer, humain. »

Tu le prends dans tes bras, puis tu entres dans le vortex.

Un bourdonnement. Une sensation de chute sans fin… puis l’air de la Terre. L’odeur de l’herbe. Le ciel familier.

Tu es de retour dans la vieille grange.
...
— « Je ne vais pas rentrer. Pas encore. Ce monde… a besoin de gens pour le relier à l’autre. Je veux construire ce pont. »

Nara t’aide à désactiver la machine. Le portail se referme dans un souffle stellaire.

Les mois passent. Avec l’aide de Pix, de Nara, et d’alliés rencontrés sur Skarh’th, Velmor, Xeros Prime, tu deviens un ambassadeur entre les mondes.

Un humain perdu, devenu lien vivant entre espèces, civilisations, et galaxies.
...
Nara t’aide à te relever et te jete un regard empathique.
