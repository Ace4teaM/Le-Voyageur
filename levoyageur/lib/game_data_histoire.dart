//
// Histoire décrit par chapitre
// La lecture utilise une syntaxe particulière pour déterminer les choix et les numéros d'étapes associés
// ... texte ...            <= Texte a afficher
// A: ...                   <= Choix de la réponse A
// B: ...                   <= Choix de la réponse B
// A. ...                   <= Texte de la réponse A
// B. ...                   <= Texte de la réponse B

class StoryText {
  static const String chapitre1 = '''
...
Tu acceptes de partir en quête des pièces avec son aide. Elle te prête un vaisseau rafistolé — le Cribleur — et un petit robot nommé Pix, ton guide maladroit mais loyal.
  ...
  ''';
  static const String chapitre3 = '''
Tu fais la connaissance de Nara, une mécanicienne Mirolienne (mi-humaine, mi-robotique), qui t’explique que les pièces dont tu as besoin sont réparties sur différentes planètes de la Confédération Zenthari. Mais attention : ces planètes ne sont pas toutes hospitalières. Certaines sont en guerre, d’autres hostiles à toute forme de vie étrangère.

Tu acceptes de partir en quête des pièces avec son aide. Elle te prête un vaisseau rafistolé — le Cribleur — et un petit robot nommé Pix, ton guide maladroit mais loyal.

  ''';
  static const String chapitre4 = '''
...
B: Tenter de négocier avec des contrebandiers locaux pour obtenir la pièce contre un service.
  ''';
  static const String chapitre5 = '''
Option 1 : Entrer en douce la nuit, malgré les vargs
...
Option 2 : Négocier avec les contrebandiers
...
Tenter l’Épreuve de l’Équilibre pour mériter la confiance des Né’Kaari.

Chercher un passage secret vers le sanctuaire, en contournant leur société.
...
Mettre le cap vers Xeros Prime malgré les dangers ?

Rejoindre Nara pour réparer ce que tu as déjà et voir si tu peux rentrer ?


  ''';
  static const String chapitre9 = '''
...
B:Rester et aider à bâtir un pont entre les mondes.
  ...
  ''';
  static const String chapitreFinal = '''
...
Tu sens le poids de ta décision : retourner chez toi, ou rester ici, là où tu t’es forgé en héros, pour un monde que tu ne connaissais pas mais où tu as trouvé ta place.
  ...
  ''';
  static const String fin1 = '''

  ''';
  static const String fin2 = '''
